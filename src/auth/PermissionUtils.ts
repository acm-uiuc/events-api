 ...
 * @returns {boolean}
 */
 const hasRequiredDelegatedPermissions = (accessTokenPayload: Record<any, any>, requiredPermission: String[]) => {
 ...
 * @returns {boolean}
 */
const hasRequiredApplicationPermissions = (accessTokenPayload: Record<any, any>, requiredPermission: String[]) => {
    const normalizedRequiredPermissions = requiredPermission.map((permission: String) => permission.toUpperCase());
